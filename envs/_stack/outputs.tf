...
output "registry_url" {
  ...
  value       = one(module.artifact_registry[*].registry_url)
}

output "registry_host" {
  description = "Registry hostname. Null where the environment does not create the repository."
  value       = one(module.artifact_registry[*].registry_host)
}
